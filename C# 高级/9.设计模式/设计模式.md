设计模式原则，就是在面向对象语言开发过程中，推荐的一些指导性原则，一些项目构成的建议，不许要强制遵守。虽然原则不是编译器强制的，但在团队协作和架构设计中，它们都是尽力去遵守哦，否则代码很容易变得难以维护。
...
如果要再加一个手机对象，供Student使用呢，那高低层都要写，并且高层的代码会受低层的影响，就要求先开发低层代码再开发高层代码，如果工作中高低层是交给两个人开发的，那就会有影响。
